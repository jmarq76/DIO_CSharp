...
namespace Vaquinha.Tests.Common.Fixtures
{
    ...
    public class DoacaoFixture
    {
        ...
        public Doacao DoacaoAnonimaValida(bool emailInvalido = false, double? valor = 5, bool maxLenghField = false, bool doacaoAnonima = true)
        {
            var faker = new Faker<Doacao>("pt_BR");
            ...
            faker.CustomInstantiator(f => new Doacao(Guid.Empty, Guid.Empty, Guid.Empty, valor ?? (double)f.Finance.Amount(MIN_VALUE, MAX_VALUE, DECIMALS),
                                                    PessoaValida(emailInvalido, maxLenghField, doacaoAnonima), null, null));
        ...
        public Pessoa PessoaValida(bool emailInvalido = false,bool maxLenghField = false, bool pessoaAnonima = false)
        {            
            ...
            faker.CustomInstantiator(f =>
                 new Pessoa(Guid.NewGuid(), pessoa.FullName, string.Empty, pessoaAnonima, maxLenghField ? f.Lorem.Sentence(501) : f.Lorem.Sentence(30)))
